namespace Loupedeck.GestureControlPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LauzhackPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LauzhackPlugin.Resources.Resource.txt`.
