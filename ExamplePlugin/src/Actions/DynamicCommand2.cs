namespace Loupedeck.ExamplePlugin
{
    ...
    public class ActionMeta2
    {
        public string Title { get; set; } = "";
        public string IconPath { get; set; } = ""; 
    }

    public class DynamicCommand2 : PluginDynamicCommand
    {
        ...
        // Variabili di stato
        private ActionMeta2 _currentMeta = new ActionMeta2();
        private FileSystemWatcher _watcher;

        public DynamicCommand2()
            : base(displayName: "Dynamic AI Action 2", description: "Action updated by Python", groupName: "AI Commands")
        {
            ...
            if (Directory.Exists(BasePath))
            {
                try 
                {
                    ...
                    _watcher.Filter = "script_2.json"; // Ascolta solo il file di metadati
        ...
        // Evento: Scatta quando Python modifica script_2.json
        ...
        private void UpdateMetaFromFile()
        {
            try
            {
                if (File.Exists(MetaPath))
                {
                    ...
                    var meta = JsonConvert.DeserializeObject<ActionMeta2>(jsonContent);
