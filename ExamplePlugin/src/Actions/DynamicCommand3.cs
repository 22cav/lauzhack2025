namespace Loupedeck.ExamplePlugin
{
    ...
    public class DynamicCommand3 : PluginDynamicCommand
    {
        ...
        public DynamicCommand3()
            : base(displayName: "Dynamic AI Action 3", description: "Action updated by Python", groupName: "AI Commands")
        {
            ...
            if (Directory.Exists(BasePath))
            {
                try 
                {
                    ...
                    _watcher.Filter = "script_3.json"; // Ascolta solo il file di metadati
        ...
        // Evento: Scatta quando Python modifica script_3.json
