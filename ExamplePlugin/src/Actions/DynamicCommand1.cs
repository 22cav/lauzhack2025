namespace Loupedeck.ExamplePlugin
{
    ...
    public class DynamicCommand1 : PluginDynamicCommand
    {
        ...
        private string ScriptPath => Path.Combine(BasePath, "script_1.py");
        private string MetaPath => Path.Combine(BasePath, "script_1.json");
        ...
        public DynamicCommand1()
            : base(displayName: "Dynamic AI Action 1", description: "Action updated by Python", groupName: "AI Commands")
        {
            ...
            if (Directory.Exists(BasePath))
            {
                try 
                {
                    ...
                    _watcher.Filter = "script_1.json"; // Ascolta solo il file di metadati
        ...
        // Evento: Scatta quando Python modifica script_1.json
